...
class WCWalletType(WalletWizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ChoiceItem(key='imported', label=_('Import WojakCoin addresses or private keys')),
        ]
...
class WCImport(WalletWizardComponent):
    def __init__(self, parent, wizard):
        WalletWizardComponent.__init__(self, parent, wizard, title=_('Import WojakCoin Addresses or Private Keys'))
        message = _(
            'Enter a list of WojakCoin addresses (this will create a watching-only wallet), or a list of private keys.')
